...
By default, the pipeline is configured to use Google's stable Gemini models (`gemini-2.5-pro` and `gemini-2.5-flash`). Ensure you have your `GEMINI_API_KEY` exported in your terminal or saved in your local `.env` file.
